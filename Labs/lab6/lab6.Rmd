...
**The three parameter model has the null that the mean of the three time periods are equal, meaning that the three time periods have similar levels of relative abundance for the gene. One of the assumptions of the two parameter (linear) model is linearity. This assumption is not true for all the genes. For instance,** **with gene** **NC101_03447 there is not a linear relationship between the relative abundance and time since the relative abundance rises in the middle. Therefore, the three parameter model is more appropriate for the data.**
